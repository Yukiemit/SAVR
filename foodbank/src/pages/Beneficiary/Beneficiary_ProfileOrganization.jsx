...
export default function Beneficiary_Profile_Organization() {
    ...
    <div className="dp-wrapper">
      ...
      <main className="dp-main">
        ...
        <div className="dp-info-card">
          <div className="dp-info-card-header">
            <div>
              <span className="dp-info-eyebrow">BENEFICIARY COUNT</span>
              <h3 className="dp-info-title">
                Served <span className="dp-info-title-accent">Individuals</span>
              </h3>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <div className="dp-fields-grid">
              ...
              {/* Age ranges matching RegisterBeneficiary */}
              <DpField label="Infants (0–2 yrs)"          name="count_infants"    val={val} editing={editing} onChange={handleChange} type="number" small />
              <DpField label="Children (3–12 yrs)"        name="count_children"   val={val} editing={editing} onChange={handleChange} type="number" small />
              <DpField label="Teenagers (13–17 yrs)"      name="count_teenagers"  val={val} editing={editing} onChange={handleChange} type="number" small />
              <DpField label="Adults (18–59 yrs)"         name="count_adults"     val={val} editing={editing} onChange={handleChange} type="number" small />
              <DpField label="Senior Citizens (60+ yrs)"  name="count_seniors"    val={val} editing={editing} onChange={handleChange} type="number" small />
              <DpField label="Persons with Disability"    name="count_pwd"        val={val} editing={editing} onChange={handleChange} type="number" small />
              <DpField label="Pregnant / Lactating Women" name="count_pregnant"   val={val} editing={editing} onChange={handleChange} type="number" small />
        ...
        <div className="dp-info-card">
          ...
          {loading ? (
            ...
            <div className="dp-fields-grid">
              ...
              <DpField label="Position / Role"  name="position"        val={val} editing={editing} onChange={handleChange} />
              <DpField label="Contact Number"   name="contact"         val={val} editing={editing} onChange={handleChange} />
              <DpField label="Email Address"    name="email"           val={val} editing={editing} onChange={handleChange} type="email" full />
