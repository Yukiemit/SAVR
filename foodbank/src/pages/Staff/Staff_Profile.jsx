...
export default function Staff_Profile() {
  ...
  const handleChangePassword = async (e) => {
    ...
    setPwLoading(true);
    try {
      await api.post("/staff/change-password", pwForm);
    ...
    <div className="sp-wrapper">
      ...
      <main className="sp-main">
        ...
        <div className="sp-page-header">
          <button className="sp-back-btn" onClick={() => navigate("/staff/dashboard")}>
          ...
          <div className="sp-body">
            ...
            <div className="sp-sidebar">
              ...
              <p className="sp-sidebar-name">
                {[form.first_name, form.last_name].filter(Boolean).join(" ") || "Staff"}
              </p>
              ...
              <form className="sp-card" onSubmit={handleSave}>
                ...
                <div className="sp-form-grid">
                  ...
                  <div className="sp-field">
                    ...
                    <input className={inp} type="text" placeholder="e.g., Operations"
